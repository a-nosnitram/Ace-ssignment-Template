...
language = "${language}"
report_extention = "${report_extention}"
...
"""
    ...
    make_test_script(language, report_extention, src_path)
...
def make_test_script(language, report_extention, src_path):
    ...
    test_script_contents = LINK_TEST.substitute(language=language, report_extention=report_extention)
